# Procedure Codes - AMA CPT - CMS HCPCS - CMS HIPPS - Da Vinci Payer Data Exchange v2.2.0

* [**Table of Contents**](toc.md)
* [**FHIR Artifacts**](artifacts.md)
* **Procedure Codes - AMA CPT - CMS HCPCS - CMS HIPPS**

## ValueSet: Procedure Codes - AMA CPT - CMS HCPCS - CMS HIPPS 

| | | |
| :--- | :--- | :--- |
| *Official URL*:http://hl7.org/fhir/us/davinci-pdex/ValueSet/PDexPAInstitutionalProcedureCodes | *Version*:2.2.0 | |
| * Standards status: *[Trial-use](http://hl7.org/fhir/R4/versions.html#std-process) | [Maturity Level](http://hl7.org/fhir/versions.html#maturity): 2 | *Computable Name*:PDexPAInstitutionalProcedureCodes |
| **Copyright/Legal**: Current Procedural Terminology (CPT) is copyright 2020 American Medical Association. All rights reserved See information on the use of HCPCS Level I (proprietary and owned by American Medical Association) and Level II codes [here](https://www.cms.gov/Medicare/Coding/MedHCPCSGenInfo/HCPCS_Coding_Questions) CMS maintains HIPPS. There are no known constraints on the use of HIPPS. See more information about HIPPS codes [here](https://www.cms.gov/Medicare/Medicare-Fee-for-Service-Payment/ProspMedicareFeeSvcPmtGen/HIPPSCodes) | | |
...
```json
{
  ...
  "id" : "PDexPAInstitutionalProcedureCodes",
  "extension" : [{
  ...
  "url" : "http://hl7.org/fhir/us/davinci-pdex/ValueSet/PDexPAInstitutionalProcedureCodes",
  "version" : "2.2.0",
  "name" : "PDexPAInstitutionalProcedureCodes",
