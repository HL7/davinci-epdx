# Prior Authorization value categories - Da Vinci Payer Data Exchange v2.2.0
...
| | |
| :--- | :--- |
| *Official URL*:http://hl7.org/fhir/us/davinci-pdex/ValueSet/PriorAuthorizationAmounts | *Version*:2.2.0 |
| * Standards status: *[Informative](http://hl7.org/fhir/R4/versions.html#std-process) | *Computable Name*:PriorAuthorizationAmounts |
...
```json
{
  ...
  "url" : "http://hl7.org/fhir/us/davinci-pdex/ValueSet/PriorAuthorizationAmounts",
  "version" : "2.2.0",
  "name" : "PriorAuthorizationAmounts",
