# Use Case Scenarios - Da Vinci Payer Data Exchange v2.2.0
...
[Previous Page - VitalSigns](VitalSigns.md)
...
1. What procedures has the patient had?
1. What medications has the patient received (i.e., a claim for a medication has been settled by the health plan).
...
[Next Page - CDS-Hooks](cds-hooks.md)
