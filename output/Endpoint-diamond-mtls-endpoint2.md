# diamond-mtls-endpoint2 - Da Vinci Payer Data Exchange v2.2.0

* [**Table of Contents**](toc.md)
* [**FHIR Artifacts**](artifacts.md)
* **diamond-mtls-endpoint2**

## Example Endpoint: diamond-mtls-endpoint2
...
**identifier**: Diamond-mtls-endpoint2
...
**address**: [https://mtls-dev-dmdh.safhir.io/mtlsendpoint](https://simplifier.net/resolve?scope=hl7.fhir.us.core.3.1.1@3.1.1&canonical=https://mtls-dev-dmdh.safhir.io/mtlsendpoint)
