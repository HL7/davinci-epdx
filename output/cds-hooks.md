# CDS Hooks - Da Vinci Payer Data Exchange v2.2.0
...
1. Where data can't be written to target resources, create a Document Reference that comprises a FHIR bundle and a human-readable PDF of the records being committed.
1. Where the DocumentReference resource does not support committing a FHIR bundle, store the PDF document.
1. Where the DocumentReference does not support writing a PDF, store an HTML or XHTML version.
1. Where the DocumentReference does not support HTML or XHTML content, write an ASCII text version.
...
| |
| :--- |
| ![](PDEX-SMART-Hook-SMART-InteractionMethods1.png) |
