# Other IG Artifacts - Da Vinci Payer Data Exchange v2.1.1
...
* [US Core 3.1.1 Profiles](http://hl7.org/fhir/us/core/3.1.1/profiles.html)
...
**NOTE:** exportType parameter **SHALL** be populated with a value for all PDex implementations of the $Davinci-data-export-operation. i.e., [Provider Access API](provider-access-api.md) and [Payer-to-Payer Bulk API](payertopayerbulkexchange.md).
