# PDex Member Match Group - Da Vinci Payer Data Exchange v2.1.1
...
| | |
| :--- | :--- |
| *Official URL*:http://hl7.org/fhir/us/davinci-pdex/StructureDefinition/pdex-member-match-group | *Version*:2.1.1 |
  ...
  "differential" : {
    "element" : [
      ...
      },
      {
        ...
        "comment" : "Add the patient record from the successful MemberMatch for an individual member in the Member-Match Request MemberBundle (Patient Demographics).",
        "min" : 0,
        "max" : "1",
        "type" : [
          {
