# Provider Member No Match Group - Da Vinci Payer Data Exchange v2.1.1
...
| | |
| :--- | :--- |
| *Official URL*:http://hl7.org/fhir/us/davinci-pdex/StructureDefinition/provider-member-no-match-group | *Version*:2.1.1 |
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/hl7.fhir.us.davinci-pdex|current/StructureDefinition/provider-member-no-match-group)
...
Other representations of profile: [CSV](StructureDefinition-provider-member-no-match-group.csv), [Excel](StructureDefinition-provider-member-no-match-group.xlsx), [Schematron](StructureDefinition-provider-member-no-match-group.sch) 
...
```json
{
  ...
  "url" : "http://hl7.org/fhir/us/davinci-pdex/StructureDefinition/provider-member-no-match-group",
  "version" : "2.1.1",
