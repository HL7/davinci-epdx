# Member-Provider Treatment Relationship Group - Da Vinci Payer Data Exchange v2.2.0
...
| | | |
| :--- | :--- | :--- |
| *Official URL*:http://hl7.org/fhir/us/davinci-pdex/StructureDefinition/pdex-treatment-relationship | *Version*:2.2.0 | |
...
* Examples for this Profile: [Group/example-pdex-treatment-relationship-group](Group-example-pdex-treatment-relationship-group.md)

You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/hl7.fhir.us.davinci-pdex|current/StructureDefinition/StructureDefinition-pdex-treatment-relationship.json)
...
Other representations of profile: [CSV](StructureDefinition-pdex-treatment-relationship.csv), [Excel](StructureDefinition-pdex-treatment-relationship.xlsx), [Schematron](StructureDefinition-pdex-treatment-relationship.sch) 
...
```json
{
  ...
  "url" : "http://hl7.org/fhir/us/davinci-pdex/StructureDefinition/pdex-treatment-relationship",
  "version" : "2.2.0",
  ...
  "differential" : {
    ...
    },
    {
      "id" : "Group.type",
      "path" : "Group.type",
      "short" : "Type of group (practitioners with treatment relationship)",
      "definition" : "Fixed to 'practitioner'. The Group's members are healthcare providers (Practitioner or PractitionerRole references) who have a treatment relationship with the member identified in Group.characteristic. Group.type SHALL reflect the type of entities in Group.member[]; per FHIR R4 the appropriate code for a group whose members are healthcare providers is 'practitioner'.",
      "patternCode" : "practitioner",
      "mustSupport" : true
    },
    {
      "id" : "Group.actual",
    ...
    },
    {
      ...
      "definition" : "Reference to the Payer organization that is managing and maintaining this treatment relationship group. Constrained to Organization since the managing entity is always a Payer (i.e., a healthcare organization), not a Practitioner, PractitionerRole, or RelatedPerson.",
      "type" : [{
        "code" : "Reference",
    ...
    },
    {
      ...
      "type" : [{
        "code" : "Extension",
        "profile" : ["http://hl7.org/fhir/us/davinci-pdex/StructureDefinition/treatment-relationship-details"]
      }]
    },
    {
