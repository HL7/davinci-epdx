...
Description: "A bundle that returns provenance using _revinclude=Provenance:target"
               ...
               * entry[1].resource.meta.profile = "http://hl7.org/fhir/us/davinci-pdex/StructureDefinition/pdex-entitysource-provenance"
               * entry[1].resource.target[0].reference = "MedicationDispense/1000001"
               * entry[1].resource.recorded = "2020-07-12T18:26:23.217+00:00"
               * entry[1].resource.agent[0].type = http://hl7.org/fhir/us/davinci-pdex/CodeSystem/ProvenanceAgentRoleType#source "Source"
