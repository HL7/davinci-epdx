...
git add	input/images/PDEX-SMART-Hook-SMART-InteractionMethods1.png
git add	input/images/Payer-App-InteractionMethods3.png
git add	input/images/Payer-Payer-with-member-InteractionMethods2.png
git add	input/pagecontent/HandlingDataProvenance.md
git add	output/HandlingDataProvenance.html
git add	output/PDEX-SMART-Hook-SMART-InteractionMethods1.png
git add	output/Payer-App-InteractionMethods3.png
git add	output/Payer-Payer-with-member-InteractionMethods2.png
