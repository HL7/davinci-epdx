...
* ig-data/input/pagecontent/PDex-Provenance_.md                                         *
*****************************************************************************************
{% endcomment %} -->
...
The PDex-Provenance resource is documented here: [pdex-provenance.html](pdex-provenance.html)

The PDex-Provenance record **SHOULD** be populated with the following essential fields as follows:
