...
[invoke a SMART App](https://cds-hooks.hl7.org/1.0/#link). §pdex-199: Support for this option by Health Plan systems **SHOULD** be provided. § 
...
the FHIR API is to use OAuth2.0 as the Authorization protocol. §pdex-202: The member **SHALL** authenticate using §
