...
The STU2 version of the IG incorporates changes to support the sharing of Prior Authorization information with members and providers. This is done through the profiling of the [ExplanationOfBenefit](PDexExplanationOfBenefit.html) resource. 
