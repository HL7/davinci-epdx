...
The guide has also been updated to support the adoption of US Core 6.1.0, in adddition to existing support for 
IUS Core 3.1.1. This change is implemented to enable implementers to comply with both the CMS-0057 Rule and 
the ONC's HTI-1 rule that implements US Core 6.1.0 as the base standard of US Core as of January 1, 2026.</i></b>
</div>
...
enable secure exchange of data, at scale.
