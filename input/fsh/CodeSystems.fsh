...
// -----------------------------------
CodeSystem: PdexExportModeCS
Title: "PDex Export Mode Use Cases"
Description: "Export Mode use cases for PDex bulk export."
* ^experimental = true
* ^extension.url = "http://hl7.org/fhir/StructureDefinition/structuredefinition-wg"
* ^extension.valueCode = #fm
* #provider-delta "Delta" "Request new data/records since last requested date for a regular, pre-defined set of resource types."
* #provider-snapshot "Snapshot" "Retrieve data for snapshot purposes that will NOT be incorporated into the Patient Record."
* #provider-download "Download" "Retrieve the full record for a member."
* ^caseSensitive = true
